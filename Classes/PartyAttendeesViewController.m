//
//  PartyAttendeesViewController.m
//  LootBagBuilder
//
...
- (id)init {
	...
	if( self != nil ) {
		...
		[self setTmpPartyAttendees:[NSArray arrayWithObjects:@"Matthew", @"Cameron", @"Ryan",@"Carter",@"Liam",nil]];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [self.tmpPartyAttendees count];
}
