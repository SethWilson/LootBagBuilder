//
//  PartyAttendeeDetailsViewController.m
//  LootBagBuilder
//
//  Created by Seth Wilson on 11-02-25.
...
@implementation PartyAttendeeDetailsViewController
@synthesize partyAttendeeDetailActions;
...
- (id)init {
	...
	if( self != nil ) {
		...
		[self setPartyAttendeeDetailActions:[NSArray arrayWithObjects:@"Edit Name: ", @"Choose design: ", @"Change Status: ",nil]];
		self.navigationItem.title = @"Attendee Details";
	}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [self.partyAttendeeDetailActions count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [partyAttendeeDetailActions objectAtIndex:indexPath.row]; 
